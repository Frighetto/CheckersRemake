...
<html lang="pt" style="height: 100%">
    ...
    <body style="overflow-y: none; background-color: #eee; min-height: 100%; margin: 0">            
        ...
        <div class="flex-centralizado" >
            <div id="lobby" style="overflow-y: scroll">                    
            ...
            <div id="players">                
                ...
                <div id="tabs" class="tab">
                    <button class="tablinks" style="pointer-events: none; cursor: default"></button>
                    <button class="tablinks active" onclick="tab(event, 'Salvos')">Salvos</button>
                    <button class="tablinks" onclick="tab(event, 'Deletados')">Deletados</button>
                </div>                                

                <div id="Salvos" class="tabcontent" style="display: block; overflow-y: scroll; margin: 0; padding: 0;">
                    <table class="table">   
                ...
                <div id="chat" style="width: 100%;">
                    ...
                    <input id="chat-input" onkeydown="check_enter_keypress('Lobby')" style="width: 100%; font-size: Large" maxlength="92">
                </div>
            </div> 
        </div>        
        ...
        <script>            
            const secret_identifier = '<%= request.getAttribute("secret_identifier") == null ? request.getParameter("secret_identifier") : request.getAttribute("secret_identifier") %>';
